...
public class Exercice2App {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 5; i++) {
			// Comprobamos si el juego esta entregado, de ser así lo mostramos y lo
			// devolvemos
		...
		for (int i = 0; i < juegos.length; i++) {
			// Comprobamos si la serie esta entregado, de ser así lo mostramos y lo
			// devolvemos
		...
		System.out.println("----------El videojuego con mayor numero de horas----------\n");
		...
		System.out.println("----------La serie con mayor numero de temporadas----------\n");
		// CompareTo Serie
